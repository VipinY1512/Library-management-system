class Library:
    ...
    def borrowBook(self, bookName):
        if bookName in self.books:
            ...
            print(
                "Sorry,this book has already been issued to someone else.Please wait until the book is returned")
            return False
...
if __name__ == "__main__":
    ...
    while (True):
        ...
        if a == 1:
            ...
            print("Thanks for choosing Central Library.Have a greate a day ahead")
            exit()
        else:
